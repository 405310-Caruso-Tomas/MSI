> La **ingeniería de [Software](../assets/Software.md)** es el establecimiento y uso de principios fundamentales de la ingeniería con objeto de desarrollar en forma económica software que sea **confiable** y que trabaje con eficiencia en máquinas reales.
...
![Pasted image 20250311121355.png](../assets/Pasted image 20250311121355.png.md)

La **ingeniería** de **software** es una tecnología con varias capas. 
La ingeniería de software incluye un **[PROCESO](../assets/PROCESO.md)**, **métodos** y **herramientas** para administrar y hacer ingeniería con el software.
****
###### **Compromiso con la [Calidad](../assets/Calidad.md)**
El fundamento en el que se apoya la ingeniería de software es el ***compromiso con la [Calidad](../assets/Calidad.md).*** Aunque las herramientas parecen lo más visible, Pressman enfatiza que la **calidad** es la raíz de todo, guiando las otras capas.
...
****
##### **Métodos**
Son las técnicas específicas dentro del modelo de proceso seleccionado, como usar diagramas **[UML](../assets/UML.md)** para diseñar, pruebas unitarias para verificar el código, TDD (Desarrollo Guiado por Pruebas), entre otros. 
