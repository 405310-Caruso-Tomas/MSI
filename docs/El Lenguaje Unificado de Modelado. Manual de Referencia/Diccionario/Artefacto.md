> Representa elementos tangibles del software, como archivos, bibliotecas, bases de datos o scripts, que se despliegan en **[Nodo](/El Lenguaje Unificado de Modelado. Manual de Referencia/Diccionario/Nodo)s**. 
