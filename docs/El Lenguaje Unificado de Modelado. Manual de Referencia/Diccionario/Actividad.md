> **Elemento** que representa un **comportamiento** o **[PROCESO](../../assets/PROCESO.md)** **dinámico** dentro de un **sistema**, modelado típicamente en un **[Diagrama de Actividad](../../assets/Diagrama de Actividad.md).**
