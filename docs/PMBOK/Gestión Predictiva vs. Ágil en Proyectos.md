Antes de divagar por cada enfoque, se proporciona una definición de lo que sería la **Gestión de Proyectos**.
...
Métodos ágiles como **[Scrum](/Scrum Master - Scrum Manager/Scrum)** o Kanban son ejemplos de **gestión evolutiva**, ya que promueven **iteraciones** **cortas** (**sprints**) y **adaptaciones** continuas. Sin embargo, existen [Metodología](/MSI//Scrum](/Scrum Master - Scrum Manager/Scrum)** o Kanban son ejemplos de **gestión evolutiva**, ya que promueven **iteraciones** **cortas** (**sprints**) y **adaptaciones** continuas. Sin embargo, existen [Metodología)s para las que no sería correcto clasificarlas como **ágiles**, pero si como **evolutivas** (ver ).
