...
La tendencia actual es lo que se denomina Desarrollo de Software Dirigido por Modelos (DSDM), o también MDD (Model Driven software Development). [Desarrollo Dirigido por Modelos](../assets/Desarrollo Dirigido por Modelos.md)
****
...
En el modelado, especialmente en el contexto de los sistemas de información, se emplean diversas metodologías que buscan estructurar, representar y analizar la información de manera sistemática. [Metodologías de Modelado](../assets/Metodologías de Modelado.md).
